...
import { Accounts, ContentType, HttpClient, InputBody } from '@cod3x/openapi';
import {
  Block,
  BlockTag,
...
export class CodexProvider extends Provider implements IEthereumProvider {
  ...
  public isCodexProvider(): boolean {
    return true;
  }
